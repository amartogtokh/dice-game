...
// Ð¢Ð¾Ð³Ð»Ð¾Ð¾Ð¼ Ð´ÑƒÑƒÑÑÐ°Ð½ ÑÑÑÑ…Ð¸Ð¹Ð³ Ñ…Ð°Ð´Ð³Ð°Ð»Ð°Ñ… Ñ‚Ó©Ð»Ó©Ð²Ð¸Ð¹Ð½ Ñ…ÑƒÐ²ÑŒÑÐ°Ð³Ñ‡
var isNewGame;
...
function initGame() {
  // Ð¢Ð¾Ð³Ð»Ð¾Ð¾Ð¼ ÑÑ…ÑÐ»Ð»ÑÑ Ð³ÑÐ´ÑÐ³ Ñ‚Ó©Ð»Ó©Ð²Ñ‚ Ð¾Ñ€ÑƒÑƒÐ»Ð½Ð°.
  isNewGame = true;
...
document.querySelector(".btn-roll").addEventListener("click", function() {
  if (isNewGame) {
    ...
    alert("Game is over. Select the New Game button to start");
  }
});
